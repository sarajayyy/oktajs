 ...
 * @param callback
 */
OktaAPIUsers.prototype.clearSessions = function(id, callback)
{
    if(id == undefined) throw new Error("A user ID is required when clearning sessions");
    this.request.delete("users/" + id + "/sessions", null, callback);
}
/*******************************************************************
*************** Users->User Sessions End *****************
********************************************************************
*/
